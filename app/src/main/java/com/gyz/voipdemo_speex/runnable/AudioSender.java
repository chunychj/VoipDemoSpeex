...
import com.gyz.voipdemo_speex.model.AudioData2;
import com.gyz.voipdemo_speex.model.NetConfig;
import com.gyz.voipdemo_speex.socket.DemoPackage;
...
//                if(PojoClient.channel != null && PojoClient.channel.isActive()){
//                    DemoPackage dp = new DemoPackage();
//                    dp.setType(2);
//                    dp.setData(encodedData.getRealData());
//                    PojoClient.channel.writeAndFlush(dp);
//                }
            }
        }
